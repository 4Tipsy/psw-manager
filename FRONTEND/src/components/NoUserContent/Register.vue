  ...
  <div class="shading">
    <div class="modal">
      ...
      <div class="input-wrapper">
        ...
        <input type="text" class="input__input" v-model="nameInput" @keyup.enter.prevent="performFetchRegister">
      </div>
      ...
      <div class="input-wrapper">
        ...
        <input type="text" class="input__input" v-model="emailInput" @keyup.enter.prevent="performFetchRegister">
      </div>
      ...
      <div class="input-wrapper">
        ...
        <input type="password" class="input__input" v-model="passwordInput" @keyup.enter.prevent="performFetchRegister">
      </div>
